...
<style>
    .bgwatermark {
        background: url("../public/img/kaaba-watermark.jpg");
...
<div class="row">
    ...
    <div class="col-md-12 text-center hajj-head" style="">
        <p class="col-xs-3 text-left">Category "A"<br /> (BS 16 & Below)</p>
        ...
        <p class="text-right col-xs-3"><strong>Reserved = {{$resEmp[0]->hajj_limit}}</strong></p>
        {{--<p class="text-right col-xs-6"><strong>Eligible Employees = 2,682</strong></p>--}}
    </div>
</div>
            ...
            <div class="box-body">
                ...
                <div class="text-center">
                    ...
                    <div class="col-md-offset-4 col-md-4 hidden-print">
                        <div id="sevenSegment_1" class="sevenSegment"></div>
                    </div>

                    <div class="col-md-4 hidden-print">
                        <div class="col-md-12" style="margin:20px; margin-bottom:0px;">
                            <button class="btn btn-lg btn-primary" id="start_draw" onclick="draw_result(1)"> Start Draw </button>
                        </div>
            ...
            success: function(data) {
                ...
                if (data.success) {
                    ...
                    $(data.data).each(function(i, v) {
                        ...
                        if (v.short_list == 2) {
                            shortlist = ' style="background-color:#77fb8d;font-weight:bold;color:#000;"';
    ...
    function show_result() {
        $('tr').each(function(i, v) {
            if ($('td div', this).is(':hidden')) {
                ...
                console.log($("#result_table_1 tr").length);
                if ($("#result_table_1 tr").length == i) {
