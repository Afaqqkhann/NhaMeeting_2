...
@section('content')
    ...
    <div class="row">
       ...
       <!-- <div class="col-xs-12 text-center" style="background-color:white; padding-top:10px; font-weight:bold;font-size:18px;">
            <p class="col-xs-4 text-left">Category "E" (Special Category)</p>
        ...
        <div class="box  box-primary" style="margin-top:15px;">
            <div class="box-body">
                ...
                <div class="text-center col-md-12">
                    ...
                    <div class="col-md-4 hidden-print">
                        <div class="col-md-12" style="margin:20px; margin-bottom:0px;">
                            <button class="btn btn-lg btn-primary" id="start_draw" onclick="draw_result(5)"> Start Draw </button>
                        </div>
                    ...
                    <table class="table table-striped bordered text-left">
                        <tr class="hidden-print">
                            ...
                            <th>TeamName</th>
                           <!-- <th>F.Name</th> -->
                            <th>Team Manager/Captain Name</th>
                           <!-- <th>BS</th> -->
                          <!--  <th>CNIC</th> -->
                            <th>Station</th>
                            <!-- <th>S/R</th> -->
                ...
                <div class="col-md-12 text-right">
                    <a target="_blank" href="{{ url('cricket/print') }}" id="print_btn" style="display:none;" class="hidden-print btn btn-lg btn-primary">Print</button>
                </div>
...
<script>
    ...
    function draw_result(id) {
        ...
        interval = setInterval(function() {
            tmp = randomIntFromInterval(1,14);
            ...
            success: function(data) {
                ...
                if(data.success) {
                    ...
                    $(data.data).each(function(i, v) {
                        ...
                        html += '<tr'+shortlist+' ><td><div>'+ (i+1) +'</div></td><td><div class="empID">'+ v.emp_id +'</div></td><td><div>'+ v.emp_name.toUpperCase()+'</div></td><td><div>'+ v.designation.toUpperCase() +'</div></td><td><div>'+ v.place_of_posting.toUpperCase() +'</div></td></tr>';
    ...
    function show_result() {
        $('tr').each(function(i, v) {
            if($('td div', this).is(':hidden')) {
                ...
                console.log($("#result_table_5 tr").length);
                if($("#result_table_5 tr").length == i) {
