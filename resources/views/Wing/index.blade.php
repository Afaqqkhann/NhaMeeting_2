...
<div class="box  box-primary">
    <div class="box-header">
        <h3 class="box-title">List of {{$page_title or ''}}</h3>
         <a href="{{ URL::to('/wingcreate') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-user-plus "></i>Add-Wing  </a>
    </div><!-- /.box-header -->
    ...
    <div class="box-body">
        <table class="table table-bordered table-striped" id="meeting_agenda">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $key + 1 }}</td>
                    <td>{{ $type->action_title or '' }} </td>
                    <td>
                        @if ($type->action_status == 1)
                            Active
                        @elseif ($type->action_status == 0)
                            InActive
                            @endif
                    </td>
