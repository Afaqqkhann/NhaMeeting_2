...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form action="{{ url('wingstore') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
              {{ csrf_field() }}<!-- Laravel CSRF Protection -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <input type="text" name="action_title" class="form-control input-sm" id="title" placeholder="Title">
                    </div>
                </div>
