...
<div class="row">
    ...
    <div class="col-xs-12 text-center" style="background-color:white; padding-top:10px; font-weight:bold;font-size:18px;">
        <p class="col-xs-4 text-left">Category "D" (Female Employees - BS 01 to 22)</p>
            ...
            <div class="box-body">
                ...
                <div class="text-center col-md-12">
                    ...
                    <div class="col-md-offset-4 col-md-4 hidden-print">
                        <div id="sevenSegment_4" class="sevenSegment"></div>
                    </div>

                    <div class="col-md-4 hidden-print">
                        <div class="col-md-12" style="margin:20px; margin-bottom:0px;">
                            <button class="btn btn-lg btn-primary" id="start_draw" onclick="draw_result(4)"> Start Draw </button>
                        </div>
    ...
    function show_result() {
        $('tr').each(function(i, v) {
            if ($('td div', this).is(':hidden')) {
                ...
                console.log($("#result_table_4 tr").length);
                if ($("#result_table_4 tr").length == i) {
