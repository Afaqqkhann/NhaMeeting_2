    ...
    <div class="row">
        <div class="text-center">
            ...
            <div class="col-xs-6">
                ...
                <h1 class="text-center heading" style="font-size:34px; color:#2b6c80; text-decoration: underline;"><strong>Hajj Balloting 2017</strong></h1>
            </div>
            <div class="col-xs-3">
                <img src="{{url('public/img/kaaba.jpg')}}" alt="Ka'bah" style="width:80%;margin-top:15px;" />
            </div>
        </div>
        <div class="col-xs-12 text-center" style="background-color:white; padding-top:10px; font-weight:bold;font-size:18px;">
            <p class="col-xs-6 text-left">Category "C" (All employees - Age 55yrs to 60yrs)</p>
            <p class="text-right col-xs-6"><strong>Eligible Employees = 208</strong></p>
        </div>
    </div>
...
<div class="row">
        ...
        <div class="box  box-primary" style="margin-top:15px;">
            <div class="box-body">
                ...
                <div class="text-center col-md-12">
                    ...
                    <div class="col-md-offset-4 col-md-4  hidden-print"><div id="sevenSegment_3" class="sevenSegment"></div></div>
    ...
    <div class="row visible-print">
        <div class="col-xs-12 text-center">
            <div class="col-xs-3"><p style="border-top:2px solid;">DD (Welfare)</p>Secretary</div>
            <div class="col-xs-3"><p style="border-top:2px solid;">Director (MIS)</p>Member</div>
            <div class="col-xs-3"><p style="border-top:2px solid;">Director/DD (Audit)</p>Member</div>
            <div class="col-xs-3"><p style="border-top:2px solid;">Director (Accounts)</p>Member</div>
        </div>
        ...
        <div class="col-xs-12" style="margin-top:10%">
            ...
            <div class="col-xs-3 col-xs-offset-3 text-right pull-right">
                <p style="border-top:1px solid; font-size:18px;"><strong>Chairman NHA</strong></p>
            </div>
        </div>
    </div>
...
<script>
    ...
    function draw_result(id) {
        ...
        interval = setInterval(function() {
            ...
            $("#sevenSegment_"+id).sevenSeg({ value: tmp });
        }, 100);
            ...
            success: function(data) {
                ...
                if(data.success) {
                    ...
                    $(data.data).each(function(i, v) {
                        ...
                        if(v.short_list == 1) { shortlist = ' style="background-color:greenyellow;font-weight:bold;"'; short_reserve = 'Nominated'; }
                        if(v.short_list == 2) { shortlist = ' style="background-color:rgba(36, 60, 236, 0.53);font-weight:bold;color:white;"'; short_reserve = 'Reserved'; }
                        html += '<tr'+shortlist+'><td><div>'+ (i+1) +'</div></td><td><div class="empID">'+ v.emp_id +'</div></td><td><div>'+ v.emp_name +'</div></td><td><div>'+ v.f_name +'</div></td><td><div>'+ v.designation +'</div></td><td><div>'+ v.bs +'</div></td><td><div>'+ v.cnic +'</div></td><td><div>'+ v.place_of_posting +'</div></td><td><div>'+short_reserve+'</div></td></tr>';
                    });
        ...
        $('tr').each(function(i, v) {
            if($('td div', this).is(':hidden')) {
                ...
                if($("#result_table_3 tr").length == i) {
                    ...
                    $(".sevenSegment").sevenSeg({value:emp_id});
                    $("#print_btn").show();
                }
                return false;
            }
    ...
    $(".sevenSegment").sevenSeg({digits:4});
    var iArrayValue = 0;

    setInterval(function() {
        $("#sevenSegment").sevenSeg({ value: iArrayValue });
