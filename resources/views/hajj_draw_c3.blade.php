...
<div class="row">
    ...
    <div class="col-xs-12 text-center" style="background-color:white; padding-top:10px; font-weight:bold;font-size:18px;">
        <p class="col-xs-4 text-left">Category "C" (All employees - Age 55yrs to 60yrs)</p>
            ...
            <div class="box-body">
                ...
                <div class="text-center col-md-12">
                    ...
                    <div class="col-md-offset-4 col-md-4  hidden-print">
                        <div id="sevenSegment_3" class="sevenSegment"></div>
                    </div>
            ...
            success: function(data) {
                ...
                if (data.success) {
                    ...
                    $(data.data).each(function(i, v) {
                        ...
                        if (v.short_list == 1) {
                            shortlist = ' style="background-color:#f7be60;font-weight:bold;color:#0a0a0a;"';
