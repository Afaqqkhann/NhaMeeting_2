...
@section('sidebar')
    @parent
    <h1>Add Document Standard</h1>
@endsection

@section('content')
    <div class="box box-primary">
        <div class="box-header">
            <h4>Add Document Standard</h4>
        ...
        <div class="box-body">
            <form action="{{ url('docstandard/store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
              {{ csrf_field() }}<!-- Laravel CSRF Protection -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <input type="text" name="doc_title" class="form-control input-sm" id="title" placeholder="Title">
                    </div>
                </div>
    ...
    <a href="{{ URL::to('docstandard') }}" class="btn btn-primary"><i class="fa fa-arrow-circle-left">Back</i></a>
@endsection
