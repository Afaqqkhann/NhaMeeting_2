...
(function (a) {
  "object" === typeof module && module.exports
    ...
    ? define("highcharts/modules/data", ["highcharts"], function (r) {
        a(r);
        a.Highcharts = r;
        return a;
      })
      ...
      var r = a.doc,
        ...
        G = {
          ...
          post: function (a, c, m) {
            ...
            C(c, function (a, c) {
              t("input", { type: "hidden", name: c, value: a }, void 0, y);
            });
            y.submit();
            D(y);
          },
        ...
        J = (function () {
          ...
          a.prototype.getColumnDistribution = function () {
            ...
            g.forEach(function (g) {
              ...
              for (p = 0; p < f; p++)
                a.hasReader(v[p]) || a.addColumnReader(void 0, v[p]);
              h.push(a);
              x++;
            });
          ...
          a.prototype.parseCSV = function (b) {
            function g(b, g, a, d) {
              ...
              function n() {
                x > t || t > p
                  ? (++t, (q = ""))
                  : (!isNaN(parseFloat(q)) && isFinite(q)
                      ? ((q = parseFloat(q)), e("number"))
                      : isNaN(Date.parse(q))
                      ? e("string")
                      : ((q = q.replace(/\//g, "-")), e("date")),
                    k.length < w + 1 && k.push([]),
                    a || (k[w][g] = q),
                    (q = ""),
                    ++w,
            ...
            function a(b) {
              ...
              h.decimalPoint ||
                ((h.decimalPoint = g > a ? "." : ","),
                (d.decimalRegex = new RegExp(
                  "^(-?[0-9]+)" + h.decimalPoint + "([0-9]+)$"
                )));
              return f;
            }
            function e(b, g) {
                ...
                for (c = 0; c < a.length; c++)
                  !1 !== a[c]
                    ? 12 < f[c] &&
                      ...
                      "YYYY" !== e[c] &&
                      (e[c] = "YY")
                    : 12 < f[c] && "mm" === e[c] && (e[c] = "dd");
                3 === e.length &&
                  "dd" === e[1] &&
                  "dd" === e[2] &&
                  (e[2] = "YY");
                b = e.join("/");
                return (h.dateFormats || d.dateFormats)[b]
                  ? b
            ...
            var d = this,
              ...
              h = b || this.options,
              x =
                "undefined" !== typeof h.startColumn && h.startColumn
                  ? h.startColumn
                  : 0,
              ...
              c = h.csv;
            b =
              "undefined" !== typeof h.startRow && h.startRow ? h.startRow : 0;
            ...
            if (c) {
              ...
              for (q = b; q <= m; q++)
                "#" === c[q][0] ? t++ : g(c[q], q - b - t);
              (h.columnTypes && 0 !== h.columnTypes.length) ||
                !l.length ||
                !l[0].length ||
                "date" !== l[0][1] ||
                h.dateFormat ||
          ...
          a.prototype.parseTable = function () {
            ...
            b.table &&
              ((b = b.table),
              "string" === typeof b && (b = y.getElementById(b)),
              [].forEach.call(b.getElementsByTagName("tr"), function (b, f) {
                f >= a &&
                  f <= e &&
                  [].forEach.call(b.children, function (b, e) {
                    var k = g[e - d],
                      h = 1;
                    if (
                      ("TD" === b.tagName || "TH" === b.tagName) &&
                      e >= d &&
                      e <= c
                    )
                      for (
                        g[e - d] || (g[e - d] = []),
                          g[e - d][f - a] = b.innerHTML;
                        f - a >= h && void 0 === k[f - a - h];
            ...
            function b(g) {
              function k(c, k, l) {
                function n() {
                  d &&
                    f.liveDataURL === c &&
                    (a.liveDataTimeout = setTimeout(b, x));
                }
                if (!c || !/^(http|\/|\.\/|\.\.\/)/.test(c))
                  return c && e.error && e.error("Invalid URL"), !1;
              ...
              k(
                ...
                k(c.rowsURL, function (b) {
                  f.update({ data: { rows: b } });
                }) ||
                k(c.columnsURL, function (b) {
                  f.update({ data: { columns: b } });
                });
            }
            var a = this,
              f = this.chart,
          ...
          a.prototype.parseGoogleSpreadsheet = function () {
            function b(g) {
              ...
              F({
                ...
                success: function (d) {
                  g(d);
                  f.enablePolling &&
                    (a.liveDataTimeout = setTimeout(function () {
                      b(g);
                    }, k));
                },
                error: function (b, a) {
            ...
            var a = this,
              ...
              h = function () {
                ...
                var b =
                    ("ABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(f.startColumn || 0) ||
                      "A") +
                    ((f.startRow || 0) + 1),
                  a =
                    "ABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(E(f.endColumn, -1)) ||
                    "ZZ";
            ...
            c &&
              ...
              b(function (b) {
                ...
                b.forEach(function (b) {
                  for (var a = 0; a < g; a++)
                    "undefined" === typeof b[a] && (b[a] = null);
                });
                d && d.series
                  ? d.update({ data: { columns: b } })
          ...
          a.prototype.trim = function (b, a) {
            "string" === typeof b &&
              ((b = b.replace(/^\s+|\s+$/g, "")),
              a && /^[0-9\s]+$/.test(b) && (b = b.replace(/\s/g, "")),
              this.decimalRegex && (b = b.replace(this.decimalRegex, "$1.$2")));
            return b;
          };
          ...
          a.prototype.parseColumn = function (b, a) {
            ...
            m =
              g &&
              ((m && m.xAxis && "category" === P(m.xAxis)[0].type) ||
                "string" === p);
            var l = z(b.name),
              n = b.length,
              t,
              ...
              m || (0 === n && d && !l)
                ...
                ? ((b[n] = w),
                  31536e6 < w && "float" !== p
                    ? (b.isDatetime = !0)
                    : (b.isNumeric = !0),
                  "undefined" !== typeof b[n + 1] && (r = w > b[n + 1]))
                : (v && v.length && (t = this.parseDate(q)),
                  g && H(t) && "float" !== p
                    ? ((h[n] = q),
                      (b[n] = t),
                      (b.isDatetime = !0),
                      "undefined" !== typeof b[n + 1] &&
                        ((q = t > b[n + 1]),
                        q !== r &&
                          "undefined" !== typeof r &&
                    ...
                    : ((b[n] = "" === v ? null : v),
                      0 !== n &&
                        (b.isDatetime || b.isNumeric) &&
                        (b.mixed = !0)));
            }
            g && b.mixed && (c[a] = f[a]);
            if (g && r && this.options.sort)
              for (a = 0; a < c.length; a++)
                c[a].reverse(), d && c[a].unshift(c[a].pop());
          };
          a.prototype.parseDate = function (b) {
            ...
            if (a) var k = a(b);
              ...
              if (e)
                (a = this.dateFormats[e]) ||
                  (a = this.dateFormats["YYYY/mm/dd"]),
                  (d = b.match(a.regex)) && (k = a.parser(d));
              else
              ...
              d ||
                ...
                "object" === typeof d && null !== d && d.getTime
                  ? (k = d.getTime() - 6e4 * d.getTimezoneOffset())
                  : H(d) && (k = d - 6e4 * new Date(d).getTimezoneOffset()));
            }
            return k;
          };
          ...
          a.prototype.complete = function () {
            ...
            if (a.complete || a.afterComplete) {
              ...
              for (d = 0; d < this.valueCount.seriesBuilders.length; d++)
                (p = this.valueCount.seriesBuilders[d]),
              ...
              0 < c.length &&
                ...
                ((l = b[c[0].readers[0].columnIndex]),
                "undefined" !== typeof l &&
                  (l.isDatetime
                    ? (e = "datetime")
                    : l.isNumeric || (e = "category")));
              if ("category" === e)
                for (d = 0; d < c.length; d++)
                  for (p = c[d], l = 0; l < p.readers.length; l++)
                    "x" === p.readers[l].configName &&
                      (p.readers[l].configName = "name");
              for (d = 0; d < c.length; d++) {
                p = c[d];
                l = [];
          ...
          a.prototype.update = function (b, a) {
            var c = this.chart,
              e = c.options;
            b &&
              ((b.afterComplete = function (b) {
                b &&
                  (b.xAxis &&
                    c.xAxis[0] &&
                    b.xAxis.type === c.xAxis[0].options.type &&
                    delete b.xAxis,
                  c.update(b, a, !0));
              }),
              B(!0, e.data, b),
              e.data &&
                e.data.googleSpreadsheetKey &&
                !b.columns &&
                delete e.data.columns,
              this.init(e.data));
          };
          return a;
        })();
      ...
      var I = (function () {
        ...
        a.prototype.read = function (b, a) {
          ...
          this.readers.forEach(function (d) {
            ...
            c
              ? e.push(f)
              : 0 < d.configName.indexOf(".")
              ? K.prototype.setNestedProperty(e, f, d.configName)
              : (e[d.configName] = f);
          });
