...
(function (a) {
  "object" === typeof module && module.exports
    ...
    ? define("highcharts/modules/drilldown", ["highcharts"], function (x) {
        a(x);
        a.Highcharts = x;
        return a;
      })
  ...
  x(
    ...
    function (a, w, n, q, p) {
      ...
      var C = q.objectEach,
        ...
        H = q.defined,
        E = q.isString;
      G(n.defaultOptions.lang, { mainBreadcrumb: "Main" });
      n = (function () {
        function a(b, d) {
          this.group = void 0;
          this.list = [];
        ...
        a.prototype.getButtonText = function (b) {
          var a = this.chart,
            ...
            g = y(
              e.format,
              e.showFullPath ? "{level.name}" : "\u2190 {level.name}"
            );
          h = h && y(h.drillUpText, h.mainBreadcrumb);
          b =
            (e.formatter && e.formatter(b)) ||
            x(g, { level: b.levelOptions }, a) ||
            "";
          ((E(b) && !b.length) || "\u2190 " === b) &&
            H(h) &&
            (b = e.showFullPath ? h : "\u2190 " + h);
          return b;
        };
        ...
        a.prototype.renderSingleButton = function () {
          ...
          !a.drillUpButton && 0 < this.level
            ? (a.drillUpButton = this.renderButton(d, h, e))
            : a.drillUpButton &&
              (0 < this.level
          ...
          d = g.renderer
            .button(
              ...
              function (d) {
                ...
                e && (g = e.call(b, d, a));
                !1 !== g &&
                  ((d.newLevel = k.showFullPath ? a.level : b.level - 1),
                  z(b, "up", d));
              },
              u
            )
        ...
        a.prototype.renderSeparator = function (a, d) {
          ...
          a = b.renderer
            .label(h.text, a, d, void 0, void 0, void 0, !1)
        ...
        a.prototype.updateSingleButton = function () {
          ...
          a.drillUpButton &&
            a.drillUpButton.attr({ text: this.getButtonText(d) });
        };
        ...
        a.prototype.updateListElements = function () {
          ...
          h.forEach(function (b, k) {
            ...
            if (d[b.level]) {
              ...
              var p = t.button;
              if (t.separator || k)
                t.separator && k && (t.separator.destroy(), delete t.separator);
              else {
                r += u * e;
              ...
              d[b.level].updated = !0;
            } else (p = a.renderButton(b, r, e)), g && p.translate(r - p.getBBox().width, e), (r += n(p, e)), k || ((q = a.renderSeparator(r, e)), g && q.translate(r - q.getBBox().width, e), (r += n(q, e))), (d[b.level] = { button: p, separator: q, updated: !0 });
            p && p.setState(k ? 2 : 0);
          });
        };
        a.defaultBreadcrumbsOptions = {
      ...
      w.Breadcrumbs ||
        ...
        p(a, "getMargins", function () {
          ...
          if (a && !a.options.floating && a.level) {
            ...
            "bottom" === b
              ? ((this.marginBottom = (this.marginBottom || 0) + d),
                (a.yOffset = d))
              : "middle" !== b
              ? ((this.plotTop += d), (a.yOffset = -d))
              : (a.yOffset = void 0);
          }
        }),
        p(a, "redraw", function () {
  ...
  x(
    ...
    function (a, w, n, q, p, x, C, N, z, A, y, H, E, u, b) {
      function d(a) {
      ...
      n.prototype.addSeriesAsDrilldown = function (a, c) {
        this.addSingleSeriesAsDrilldown(a, c);
        this.applyDrilldown();
      };
      n.prototype.addSingleSeriesAsDrilldown = function (a, c) {
        var f = a.series,
          l = f.xAxis,
          b = f.yAxis,
          v = [],
        ...
        a = B(
          {
            ...
            resetZoomButton:
              m && m.levelNumber === e ? void 0 : this.resetZoomButton,
          },
          F
        );
        ...
        l &&
          ((l.oldPos = l.pos),
          (l.userMin = l.userMax = null),
          (b.userMin = b.userMax = null));
        f.type === c.type &&
          ((c.animate = c.animateDrilldown || h), (c.options.animation = !0));
      };
      ...
      var L = function (a) {
        ...
        (a = a.drilldownLevels) &&
          a.length &&
          (c[0] || c.push({ level: 0, levelOptions: a[0].seriesOptions }),
          a.forEach(function (a, f) {
            a.levelNumber + 1 > c[c.length - 1].level &&
              c.push({
                level: a.levelNumber + 1,
                levelOptions: t({ name: a.lowerSeries.name }, a.pointOptions),
              });
          }));
        return c;
      };
          ...
          for (
            var a = this,
              ...
              h = function (c) {
                ...
                f.type === m.type &&
                  f.animateDrillupTo &&
                  (f.animate = f.animateDrillupTo);
                c === e.seriesPurgedOptions && (g = f);
              },
              k = a.drilldownLevels.length;
            l--;
            ...
            if (((e = c[l]), e.levelNumber === b)) {
              ...
              if (!m.chart)
                for (v = d.length; v--; )
                  if (
                    d[v].options.id === e.lowerSeriesOptions.id &&
                    d[v].options._levelNumber === b + 1
                  ) {
                    m = d[v];
                    break;
                  }
              ...
              g.type === m.type &&
                ((g.drilldownLevel = e),
                (g.options.animation = a.options.drilldown.animation),
                m.animateDrillupFrom && m.chart && m.animateDrillupFrom(e));
              g.options._levelNumber = b;
              m.remove(!1);
              g.xAxis &&
                ((v = e.oldExtremes),
                g.xAxis.setExtremes(v.xMin, v.xMax, !1),
                g.yAxis.setExtremes(v.yMin, v.yMax, !1));
        ...
        (this.xAxis || []).forEach(function (a) {
          ...
          a.series.forEach(function (c) {
            ...
            for (f = 0; f < b.length; f++) {
              ...
              "number" !== typeof e &&
                ((e = c.pointClass.prototype.optionsToObject.call(
                  { series: c },
                  e
                )),
                e.drilldown &&
                  (a.ddPoints[b[f]] || (a.ddPoints[b[f]] = []),
                  (e = f - (c.cropStart || 0)),
                  a.ddPoints[b[f]].push(
                    d && 0 <= e && e < d.length ? d[e] : !0
                  )));
            }
          });
      ...
      p.prototype.animateDrilldown = function (a) {
        ...
        a ||
          (f.forEach(function (a) {
            c.options._ddSeriesId === a.lowerSeriesOptions._ddSeriesId &&
              ((d = a.shapeArgs), m || (d.fill = a.color));
          }),
          (d.x += D(h.oldPos, h.pos) - h.pos),
          this.points.forEach(function (a) {
            var b = a.shapeArgs;
            m || (b.fill = a.color);
            a.graphic &&
              a.graphic
                .attr(d)
                .animate(B(a.shapeArgs, { fill: a.color || c.color }), g);
          }),
      ...
      p.prototype.animateDrillupFrom = function (a) {
        ...
        this.points.forEach(function (e) {
          ...
          g &&
            l &&
            (delete e.graphic,
            f.chart.styledMode || (l.fill = a.color),
            c.duration
              ? g.animate(l, t(c, { complete: h }))
              : (g.attr(l), h()));
        });
      };
      y &&
        B(y.prototype, {
          ...
          animateDrilldown: function (a) {
            ...
            if (this.center) {
              ...
              a ||
                (this.points.forEach(function (a, l) {
                  var h = a.shapeArgs;
                  g || ((d.fill = c.color), (h.fill = a.color));
                  if (a.graphic)
                    a.graphic
                      .attr(t(d, { start: f + l * e, end: f + (l + 1) * e }))
                      [b ? "animate" : "attr"](h, b);
                }),
      ...
      z.prototype.runDrilldown = function (a, c, b) {
        ...
        r(
          ...
          "drilldown",
          {
            ...
            points:
              "undefined" !== typeof c &&
              this.series.xAxis.getDDPoints(c).slice(0),
          },
          function (c) {
            ...
            b &&
              d &&
              (a
                ? b.addSingleSeriesAsDrilldown(c.point, d)
                : b.addSeriesAsDrilldown(c.point, d));
          }
        );
      };
      ...
      E.prototype.drillable = function () {
        ...
        d &&
          (c && e && e.length
            ? ((c.drillable = !0),
              c.basicStyles || h || (c.basicStyles = t(c.styles)),
              c.addClass("highcharts-drilldown-axis-label"),
              c.removeOnDrillableClick && k(c.element, "click"),
              (c.removeOnDrillableClick = g(c.element, "click", function (c) {
                c.preventDefault();
                b.drilldownCategory(a, c);
              })),
              h || c.css(b.chart.options.drilldown.activeAxisLabelStyle))
            : c &&
              c.drillable &&
              c.removeOnDrillableClick &&
              (h || ((c.styles = {}), c.css(c.basicStyles)),
              c.removeOnDrillableClick(),
              c.removeClass("highcharts-drilldown-axis-label")));
      };
      ...
      var M = function (a) {
        var c = this.series;
        c.xAxis && !1 === c.chart.options.drilldown.allowPointDrilldown
          ? c.xAxis.drilldownCategory(this.x, a)
      ...
      g(z, "afterSetState", function () {
        ...
        this.drilldown && this.series.halo && "hover" === this.state
          ? I(this.series.halo, "pointer", !0, a)
          : this.series.halo && I(this.series.halo, "auto", !1, a);
      });
      g(n, "drillup", function () {
        this.resetZoomButton &&
          (this.resetZoomButton = this.resetZoomButton.destroy());
      });
      g(n, "drillupall", function () {
