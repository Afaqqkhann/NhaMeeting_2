...
//        return view('family.index', compact('page_title', 'data'));
    ...
    public function create($id)
    {
        ...
        $emp = DB::table('TBL_CHARGE')->where('charge_id','>=', 300)->where('charge_id','<=', 399)->orderBy('charge_id','DESC')->get();
        foreach($emp as $row){
    ...
    {
        $page_title = 'Add Misc posting Order';
        $reporting_officer = ['' => 'Select Reporting Officer'] + Emp::lists('emp_name', 'emp_id')->all();
...
//                'e_to'  => 	'required',
        ...
        $book->save();
            Session::flash('success', 'Misc Posting added successfully.');
...
//                'e_to'  => 	'required',
        ...
        Session::flash('success', 'Misc Posting updated successfully.');
        return Redirect('employee/emp_detail/'.$request->input('id'));
    }
    /**
    ...
    public function destroy($id)
    {
        ...
        Session::flash('success', 'Misc Posting has been deleted successfully.');
